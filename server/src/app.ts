...
import { insights, refreshInsights } from './controllers/insightController.js';
...
app.post('/api/products/analyze', controller.analyzeProduct);
...
app.get('/api/inventory/insights', insights);
app.post('/api/inventory/insights/refresh', refreshInsights);
